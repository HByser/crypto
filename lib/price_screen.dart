    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          CryptoCard(value: isWaiting ? '?' : coinValues['BTC'], selectedCurrency: selectedCurrency, cryptoCurrency: "1 BTC",),
          CryptoCard(value: isWaiting ? '?' : coinValues['ETH'], selectedCurrency: selectedCurrency, cryptoCurrency: "1 ETH",),
          CryptoCard(value: isWaiting ? '?' : coinValues['LTC'], selectedCurrency: selectedCurrency, cryptoCurrency: "1 LTC",),
          Container(
            height: 150.0,
